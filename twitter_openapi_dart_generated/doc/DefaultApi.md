...
------------- | ------------- | ------------- | -------------
 **pathQueryId** | **String**|  | [default to 'X-Sw7rvhcUhof35mh5ObKw']
...
final api = TwitterOpenapiDartGenerated().getDefaultApi();
final String pathQueryId = MWY3AO9_I3rcP_L2A4FR4A; // String | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **pathQueryId** | **String**|  | [default to 'MWY3AO9_I3rcP_L2A4FR4A']
