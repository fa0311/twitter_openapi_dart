...
[**getLikes**](DefaultApi.md#getlikes) | **GET** /5fmEkRT-1AdHqEsbVgehMg/Likes | 
[**getListLatestTweetsTimeline**](DefaultApi.md#getlistlatesttweetstimeline) | **GET** /2TemLyqrMpTeAmysdbnVqw/ListLatestTweetsTimeline | 
[**getProfileSpotlightsQuery**](DefaultApi.md#getprofilespotlightsquery) | **GET** /9zwVLJ48lmVUk8u_Gh9DmA/ProfileSpotlightsQuery | 
[**getTweetDetail**](DefaultApi.md#gettweetdetail) | **GET** /wNNG8DBB8EaXw1lq4vFWGA/TweetDetail | 
[**getUserByScreenName**](DefaultApi.md#getuserbyscreenname) | **GET** /sLVLhk0bGj3MVFEKTdax1w/UserByScreenName | 
[**getUserMedia**](DefaultApi.md#getusermedia) | **GET** /YqiE3JL1KNgf9nSljYdxaA/UserMedia | 
[**getUserTweets**](DefaultApi.md#getusertweets) | **GET** /HuTx74BxAnezK1gWvYY7zg/UserTweets | 
[**getUserTweetsAndReplies**](DefaultApi.md#getusertweetsandreplies) | **GET** /RIWc55YCNyUJ-U3HHGYkdg/UserTweetsAndReplies | 
...
try {
    ...
    print('Exception when calling DefaultApi->getLikes: $e\n');
}
```
...
try {
    ...
    print('Exception when calling DefaultApi->getTweetDetail: $e\n');
}
```
...
try {
    ...
    print('Exception when calling DefaultApi->getUserByScreenName: $e\n');
}
```
...
try {
    ...
    print('Exception when calling DefaultApi->getUserMedia: $e\n');
}
```
...
try {
    ...
    print('Exception when calling DefaultApi->getUserTweets: $e\n');
}
```
...
try {
    ...
    print('Exception when calling DefaultApi->getUserTweetsAndReplies: $e\n');
}
```
