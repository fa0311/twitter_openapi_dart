...
# **getFollowers**
> FollowResponse getFollowers(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent)
...
try {
    final response = api.getFollowers(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent);
    print(response);
} catch on DioError (e) {
...
# **getFollowing**
> FollowResponse getFollowing(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent)
...
try {
    final response = api.getFollowing(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent);
    print(response);
} catch on DioError (e) {
