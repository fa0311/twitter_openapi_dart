...
# **getBookmarks**
> BookmarksResponse getBookmarks(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent)
...
try {
    final response = api.getBookmarks(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent);
    print(response);
} catch on DioError (e) {
...
> TimelineResponse getHomeLatestTimeline(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent)
...
try {
    final response = api.getHomeLatestTimeline(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent);
    print(response);
} catch on DioError (e) {
...
# **getHomeTimeline**
> TimelineResponse getHomeTimeline(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent)
...
try {
    final response = api.getHomeTimeline(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent);
    print(response);
} catch on DioError (e) {
...
# **getLikes**
> UserTweetsResponse getLikes(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent)
...
try {
    final response = api.getLikes(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent);
    print(response);
} catch on DioError (e) {
...
> ListTweetsTimelineResponse getListLatestTweetsTimeline(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent)
...
try {
    final response = api.getListLatestTweetsTimeline(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent);
    print(response);
} catch on DioError (e) {
...
# **getTweetDetail**
> TweetDetailResponse getTweetDetail(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent)
...
try {
    final response = api.getTweetDetail(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent);
    print(response);
} catch on DioError (e) {
...
# **getUserMedia**
> UserTweetsResponse getUserMedia(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent)
...
try {
    final response = api.getUserMedia(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent);
    print(response);
} catch on DioError (e) {
...
# **getUserTweets**
> UserTweetsResponse getUserTweets(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent)
...
try {
    final response = api.getUserTweets(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent);
    print(response);
} catch on DioError (e) {
...
> UserTweetsResponse getUserTweetsAndReplies(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent)
...
try {
    final response = api.getUserTweetsAndReplies(queryId, variables, features, authorization, xTwitterActiveUser, xTwitterClientLanguage, userAgent);
    print(response);
} catch on DioError (e) {
