...
/// * [possiblySensitive] 
@BuiltValue()
abstract class PostCreateTweetVariablesParameterMedia implements Built<PostCreateTweetVariablesParameterMedia, PostCreateTweetVariablesParameterMediaBuilder> {
  ...
  factory PostCreateTweetVariablesParameterMedia([void updates(PostCreateTweetVariablesParameterMediaBuilder b)]) = _$PostCreateTweetVariablesParameterMedia;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PostCreateTweetVariablesParameterMediaBuilder b) => b
      ..possiblySensitive = false;

  @BuiltValueSerializer(custom: true)
  static Serializer<PostCreateTweetVariablesParameterMedia> get serializer => _$PostCreateTweetVariablesParameterMediaSerializer();
}

class _$PostCreateTweetVariablesParameterMediaSerializer implements PrimitiveSerializer<PostCreateTweetVariablesParameterMedia> {
  @override
  final Iterable<Type> types = const [PostCreateTweetVariablesParameterMedia, _$PostCreateTweetVariablesParameterMedia];
