...
@BuiltValue()
abstract class PostCreateTweetFeaturesParameter implements Built<PostCreateTweetFeaturesParameter, PostCreateTweetFeaturesParameterBuilder> {
  ...
  factory PostCreateTweetFeaturesParameter([void updates(PostCreateTweetFeaturesParameterBuilder b)]) = _$PostCreateTweetFeaturesParameter;
  ...
  static Serializer<PostCreateTweetFeaturesParameter> get serializer => _$PostCreateTweetFeaturesParameterSerializer();
}

class _$PostCreateTweetFeaturesParameterSerializer implements PrimitiveSerializer<PostCreateTweetFeaturesParameter> {
  @override
  final Iterable<Type> types = const [PostCreateTweetFeaturesParameter, _$PostCreateTweetFeaturesParameter];
