...
class _$ErrorResponse extends ErrorResponse {
  ...
  _$ErrorResponse._({required this.errors}) : super._() {
    BuiltValueNullFieldError.checkNotNull(errors, r'ErrorResponse', 'errors');
  }
...
class ErrorResponseBuilder
  ...
  ErrorsBuilder? _errors;
  ErrorsBuilder get errors => _$this._errors ??= new ErrorsBuilder();
  set errors(ErrorsBuilder? errors) => _$this._errors = errors;
  ...
  _$ErrorResponse _build() {
    ...
    try {
      _$result = _$v ?? new _$ErrorResponse._(errors: errors.build());
    } catch (_) {
