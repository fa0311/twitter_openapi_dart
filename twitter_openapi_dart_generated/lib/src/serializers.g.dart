...
Serializers _$serializers = (new Serializers().toBuilder()
      ...
      ..add(BirdwatchPivotSubtitle.serializer)
      ..add(BirdwatchPivotVisualStyleEnum.serializer)
      ...
      ..add(CoverCta.serializer)
      ..add(CoverCtaButtonStyleEnum.serializer)
      ...
      ..add(CtaClientEventInfo.serializer)
      ..add(CtaClientEventInfoActionEnum.serializer)
      ..add(CursorType.serializer)
      ..add(DeleteRetweet.serializer)
      ..add(DeleteRetweetResponse.serializer)
      ..add(DeleteRetweetResponseData.serializer)
      ..add(DeleteRetweetResponseResult.serializer)
      ...
      ..add(ExtMediaAvailability.serializer)
      ..add(ExtMediaAvailabilityStatusEnum.serializer)
      ...
      ..add(GetBookmarks200Response.serializer)
      ..add(GetFavoriters200Response.serializer)
      ..add(GetFollowers200Response.serializer)
      ..add(GetHomeLatestTimeline200Response.serializer)
      ..add(GetLikes200Response.serializer)
      ..add(GetListLatestTweetsTimeline200Response.serializer)
      ..add(GetProfileSpotlightsQuery200Response.serializer)
      ..add(GetRetweeters200Response.serializer)
      ..add(GetSearchTimeline200Response.serializer)
      ..add(GetTweetDetail200Response.serializer)
      ..add(GetTweetResultByRestId200Response.serializer)
      ...
      ..add(MediaExtended.serializer)
      ..add(MediaExtendedTypeEnum.serializer)
      ..add(MediaOriginalInfo.serializer)
      ..add(MediaOriginalInfoFocusRect.serializer)
      ..add(MediaSize.serializer)
      ..add(MediaSizeResizeEnum.serializer)
      ..add(MediaSizes.serializer)
      ..add(MediaStats.serializer)
      ..add(MediaTypeEnum.serializer)
      ..add(MediaVideoInfo.serializer)
      ..add(MediaVideoInfoVariant.serializer)
      ..add(ModuleEntry.serializer)
      ..add(ModuleItem.serializer)
      ..add(NoteTweet.serializer)
      ..add(NoteTweetResult.serializer)
      ..add(NoteTweetResultData.serializer)
      ..add(NoteTweetResultMedia.serializer)
      ..add(NoteTweetResultMediaInlineMedia.serializer)
      ..add(NoteTweetResultRichText.serializer)
      ..add(NoteTweetResultRichTextTag.serializer)
      ..add(NoteTweetResultRichTextTagRichtextTypesEnum.serializer)
      ..add(OneFactorLoginEligibility.serializer)
      ..add(Other200Response.serializer)
      ..add(OtherResponse.serializer)
      ..add(PostCreateRetweet200Response.serializer)
      ..add(PostCreateRetweetRequest.serializer)
      ..add(PostCreateRetweetRequestVariables.serializer)
      ..add(PostCreateTweet200Response.serializer)
      ...
      ..add(PostCreateTweetRequestVariablesMediaMediaEntitiesInner.serializer)
      ..add(PostCreateTweetRequestVariablesReply.serializer)
      ..add(PostDeleteRetweet200Response.serializer)
      ..add(PostDeleteRetweetRequest.serializer)
      ..add(PostDeleteRetweetRequestVariables.serializer)
      ..add(PostDeleteTweet200Response.serializer)
      ..add(PostDeleteTweetRequest.serializer)
      ..add(PostFavoriteTweet200Response.serializer)
      ...
      ..add(TimelineMessagePrompt.serializer)
      ..add(TimelinePinEntry.serializer)
      ..add(TimelinePrompt.serializer)
      ...
      ..add(TimelineShowCover.serializer)
      ...
      ..add(TweetEditControlInitial.serializer)
      ...
      ..add(TweetView.serializer)
      ..add(TweetViewStateEnum.serializer)
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(BirdwatchEntity)]),
          () => new ListBuilder<BirdwatchEntity>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(BirdwatchEntity)]),
          () => new ListBuilder<BirdwatchEntity>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<BuiltMap<String, JsonObject?>>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(Callback)]),
          () => new ListBuilder<Callback>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(Callback)]),
          () => new ListBuilder<Callback>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(MediaExtended)]),
          () => new ListBuilder<MediaExtended>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(MediaOriginalInfoFocusRect)]),
          () => new ListBuilder<MediaOriginalInfoFocusRect>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(ModuleItem)]),
          () => new ListBuilder<ModuleItem>())
      ..addBuilderFactory(
          const FullType(BuiltList,
              const [const FullType(NoteTweetResultMediaInlineMedia)]),
          () => new ListBuilder<NoteTweetResultMediaInlineMedia>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(NoteTweetResultRichTextTag)]),
          () => new ListBuilder<NoteTweetResultRichTextTag>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [
            const FullType(NoteTweetResultRichTextTagRichtextTypesEnum)
          ]),
      ...
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(TweetCardLegacyBindingValue)]),
          () => new ListBuilder<TweetCardLegacyBindingValue>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(MediaVideoInfoVariant)]),
          () => new ListBuilder<MediaVideoInfoVariant>())
      ..addBuilderFactory(
          const FullType(BuiltMap, const [
            const FullType(String),
            const FullType.nullable(JsonObject)
