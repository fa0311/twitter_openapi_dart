...
class V11PostApi {
  ...
  ///
  /// Parameters:
  /// * [postCreateFriendshipsRequest] - body
  ...
  Future<Response<void>> postCreateFriendships({ 
    required PostCreateFriendshipsRequest postCreateFriendshipsRequest,
    ...
    try {
      const _type = FullType(PostCreateFriendshipsRequest);
      _bodyData = _serializers.serialize(postCreateFriendshipsRequest, specifiedType: _type);
