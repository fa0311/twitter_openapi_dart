...
Serializers _$serializers = (new Serializers().toBuilder()
      ...
      ..add(HomeTimelineData.serializer)
      ..add(HomeTimelineHome.serializer)
      ..add(HomeTimelineResponse.serializer)
      ..add(HomeTimelineUrt.serializer)
      ...
      ..add(TweetResult.serializer)
      ..add(TweetResultEditControl.serializer)
      ..add(TweetResultEditPrespective.serializer)
      ..add(TweetResultViews.serializer)
      ..add(TypeName.serializer)
      ..add(UserLegacy.serializer)
      ..add(UserResult.serializer)
