...
class _$HomeTimelineData extends HomeTimelineData {
  ...
  _$HomeTimelineData._({required this.home}) : super._() {
    BuiltValueNullFieldError.checkNotNull(home, r'HomeTimelineData', 'home');
  }
...
class HomeTimelineDataBuilder
  ...
  _$HomeTimelineData _build() {
    ...
    try {
      _$result = _$v ?? new _$HomeTimelineData._(home: home.build());
    } catch (_) {
