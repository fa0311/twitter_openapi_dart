...
class DefaultApi {
  ...
  ///
  /// Parameters:
  /// * [homeTimelineData] - Update an existent pet in the store
  ...
  Future<Response<HomeTimelineData>> bntFPEOxs3GYdPaS6CjUcgHomeTimelineGet({ 
    required HomeTimelineData homeTimelineData,
    ...
    try {
      const _type = FullType(HomeTimelineData);
      _bodyData = _serializers.serialize(homeTimelineData, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [HomeTimelineData] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<HomeTimelineData>> faBzCqZXuQCb4PhB0RHqHwFollowingGet({ 
    required HomeTimelineData homeTimelineData,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [HomeTimelineData] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<HomeTimelineData>> vptSi88PiaQhBevFbGVlGgFollowersGet({ 
    required HomeTimelineData homeTimelineData,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
