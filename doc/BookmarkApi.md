# twitter_openapi_dart.api.BookmarkApi
...
[**getTweetDetail**](BookmarkApi.md#gettweetdetail) | **GET** /wNNG8DBB8EaXw1lq4vFWGA/TweetDetail | 
...
try {
    ...
    print('Exception when calling BookmarkApi->getTweetDetail: $e\n');
}
```
